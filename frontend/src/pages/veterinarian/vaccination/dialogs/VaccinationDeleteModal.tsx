...
export default function VaccinationDeleteModal({
    vaccination,
    isOpen,
    onClose,
    onDelete,
}: VaccinationDeleteModalProps) {
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        ...
                        <strong>{vaccination.animal?.name ?? "this animal"}</strong>? This action cannot be undone.
                    </DialogDescription>
                </DialogHeader>
