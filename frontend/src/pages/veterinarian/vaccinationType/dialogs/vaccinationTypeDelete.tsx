...
export default function VaccinationTypeDeleteModal({ vaccinationType, isOpen, onClose, onDelete }: VaccinationTypeDeleteModalProps) {
      ...
      <DialogContent className="w-[95vw] sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription className="text-sm">
            Are you sure you want to delete the vaccination type <strong>{vaccinationType.vaccineName}</strong>? This action cannot be undone.
          </DialogDescription>
        </DialogHeader>
